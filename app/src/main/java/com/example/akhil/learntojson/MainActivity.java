package com.example.akhil.learntojson;
...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //Initiate data retrieval when the 'Get' button is pressed
    ...
    private class GetMetaWeatherData extends AsyncTask<Void, Void, Void>
    {
        ...
        protected Void doInBackground(Void... arg0)
        {
            ...
            String url = "https://www.metaweather.com/api/location/search/?lattlong="+lat+","+longi;
            ...
            if (jsonStr != null) {
                try {
                    ...
                    // Looping through all the cities near the given coordinates and retrieving and storing attirbutes
                    for (int i = 0; i < cities.length(); i++)
                    {
                        JSONObject c = cities.getJSONObject(i);
                        String distance = "distance: " + c.getString("distance");
                        String title = c.getString("title");
                        String location_type = c.getString("location_type");
                        String woeid = "woeid: " + c.getString("woeid");
                        String latt_long = c.getString("latt_long");
